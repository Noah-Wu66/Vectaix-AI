...
Vectaix AI 是一个**开源 AI 工作空间**，专为 Vercel 云原生部署设计。它将全球顶尖的 AI 模型汇聚在一个统一界面下 — 支持官方 API 直连、智能路由切换，以及独创的多专家协作系统。
...
### 🧠 Council 工作流
独创的多专家协作模式：GPT-5.4、Claude Opus 4.6、Gemini 2.5 Pro 作为并行专家回答，Seed 2.0 Pro 负责综合总结。

### 🔀 智能模型路由
用户级别的路由切换，可在官方 API 和 OpenRouter 之间灵活选择，兼顾性能与成本。
...
| 模型 | 提供商 | 路由方式 | 特长 |
|:------|:--------|:---------|:-----|
| **GPT-5.4** | OpenAI | 官方 / OpenRouter | 通用智能、编程、分析 |
| **Claude Opus 4.6** | Anthropic | 官方 / OpenRouter | 深度推理、写作、安全 |
| **Gemini 2.5 Pro** | Google | 官方 / OpenRouter | 多模态、长上下文 |
| **DeepSeek V3.2** | DeepSeek | 仅官方 | 推理、数学、代码 |
| **Seed 2.0 Pro** | 字节跳动 | 仅官方 | 中文语言、总结 |
| **MiMo V2 Flash** | 小米 | 仅 OpenRouter | 快速推理 |
| **MiniMax M2.5** | MiniMax | 仅 OpenRouter | 多语言生成 |
...
| AI SDK | @anthropic-ai/sdk、@google/genai、OpenAI REST、火山引擎 Seed |
