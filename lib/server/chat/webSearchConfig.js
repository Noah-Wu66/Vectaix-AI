...
16. timeRange 只能是空字符串、OneDay、OneWeek、OneMonth、OneYear，或者 YYYY-MM-DD..YYYY-MM-DD 这种闭区间格式之一。
17. 如果 needSearch=false，query 必须是空字符串，timeRange 必须是空字符串。
18. 只输出 JSON，不要输出任何别的文字。

返回格式：
{"needSearch":true,"query":"搜索词","timeRange":"OneWeek"}`;
