...
export const MINIMAX_M2_7_HIGHSPEED_MODEL = "minimax-m2.7";
export const LEGACY_MINIMAX_M2_7_HIGHSPEED_MODEL = "minimax-m2.7-highspeed";
...
export const PRIMARY_CHAT_MODELS = Object.freeze(
...
export const DEFAULT_MODEL = AGENT_MODEL_ID;
...
export function normalizeModelId(model) {
  ...
  if (normalized === LEGACY_MINIMAX_M2_7_HIGHSPEED_MODEL) {
    return MINIMAX_M2_7_HIGHSPEED_MODEL;
  }
  return normalized;
}
