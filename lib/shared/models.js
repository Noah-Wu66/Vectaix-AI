...
export const GEMINI_PRO_MODEL = "gemini-3.1-pro";
...
export const QWEN_MODEL_ID = "qwen3.6-plus";
...
export const AGENT_MODE_DISABLED_REASON = "升级中，暂不可用";
export const DEFAULT_CHAT_RUNTIME_MODE = AGENT_MODE_ENABLED ? CHAT_RUNTIME_MODE_AGENT : CHAT_RUNTIME_MODE_CHAT;
...
export const CHAT_RUNTIME_MODES = Object.freeze([
  {
    ...
    disabled: !AGENT_MODE_ENABLED,
    disabledReason: AGENT_MODE_DISABLED_REASON,
  },
  {
...
export function isQwenModel(model) {
  const normalized = normalizeModelId(model);
  return typeof normalized === "string" && normalized.startsWith("qwen");
}
