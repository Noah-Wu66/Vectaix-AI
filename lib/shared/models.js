...
export const DEFAULT_MODEL = DEEPSEEK_CHAT_MODEL;
...
export function getDefaultMaxTokensForModel(modelId) {
  ...
  if (normalized === OPENAI_PRIMARY_MODEL || normalized === CLAUDE_OPUS_MODEL || normalized === SEED_MODEL_ID) {
    return 128000;
  }
  if (normalized === GEMINI_PRO_MODEL || normalized === QWEN_MODEL_ID) {
    return 65536;
  }
