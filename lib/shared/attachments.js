...
export function getAttachmentAcceptForModel({ supportsDocuments, supportsImages }) {
  if (supportsDocuments) return ATTACHMENT_ACCEPT;
  if (supportsImages) return IMAGE_MIME_TYPES.join(",");
  return "";
}
