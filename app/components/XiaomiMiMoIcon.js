...
const AVATAR_ICON_MULTIPLE = 0.7;

const XiaomiMiMoMono = memo(function XiaomiMiMoMono({ size = "1em", style, ...rest }) {
  return (
    <svg
      fill="currentColor"
      fillRule="evenodd"
...
const XiaomiMiMoAvatar = memo(function XiaomiMiMoAvatar({
  size = 24,
  shape = "circle",
  style,
  ...rest
  ...
  return (
    <span
      ...
      {...rest}
    >
      <XiaomiMiMoMono size={size} style={{ transform: `scale(${AVATAR_ICON_MULTIPLE})` }} />
    </span>
  );
});

const XiaomiMiMoIcon = XiaomiMiMoMono;

XiaomiMiMoIcon.Color = XiaomiMiMoMono;
XiaomiMiMoIcon.Avatar = XiaomiMiMoAvatar;
XiaomiMiMoIcon.colorPrimary = COLOR_PRIMARY;
XiaomiMiMoIcon.title = TITLE;
