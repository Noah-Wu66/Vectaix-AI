...
export default function ThinkingBlock({ thought, isStreaming, isSearching, searchQuery, searchError }) {
      ...
      <AnimatePresence>
        {!collapsed && (
          <motion.div
            ...
            className="thinking-content bg-zinc-100 border border-zinc-200 rounded-2xl p-3 overflow-y-auto max-h-[200px] w-full max-w-[800px] text-xs text-zinc-400"
            ref={containerRef}
          >
